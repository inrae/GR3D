...
public class BasinNetworkWith2Basins extends BasinNetwork {
	...
	private double fallTemperatureOfBv1 = 13.;  // Gironde estuary values : We used daily estimates of estuarine water temperature (�C) close to the Blayais nuclear power plant provided by EDF (Electricit� De France) between 1991 and 2009
